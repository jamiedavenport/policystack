...
description: Scaffold PolicyStack in a project: run the @policystack/cli installer, then wire <PolicyStackProvider> (policy + consent). Use when adding a privacy/cookie policy or a consent banner to a web app.
---
