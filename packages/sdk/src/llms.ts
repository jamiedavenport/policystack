...
import * as scanned from "./openpolicy.gen"; // generated by the openPolicy() Vite plugin

export default defineConfig({ /* OpenPolicyConfig */ }, scanned);
\`\`\`
...
when omitted. Output only a single \`openpolicy.ts\` — no explanations.
