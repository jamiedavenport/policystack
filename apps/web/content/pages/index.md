...
- **Tiny** — Consent core ships under 4kb gzipped. Policy renders zero JS by default.
- **Open source** — Apache-2.0 across the board. Cloud is the only commercial piece, and it's optional.
